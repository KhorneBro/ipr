...
a persistence unit "iprPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ipr/pom.xml":
...
artifacts ("ipr-ejb.jar" and "ipr-web.war") are already built. You can build
